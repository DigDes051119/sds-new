...
export function Contacts() {
  ...
  return (
    <div
      className="max-w-[1380px] mx-auto px-6 min-[1380px]:px-0 pt-10 md:pt-20 pb-32 md:pb-20 flex flex-col gap-12 md:gap-32 text-black"
    >
      <motion.h1 
      ...
      <div className="grid lg:grid-cols-2 gap-12 md:gap-20">
        ...
        >
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-widest text-black/40 mb-3">{t.contacts.writeUs}</h3>
          ...
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-widest text-black/40 mb-3">{t.contacts.callUs}</h3>
          ...
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-widest text-black/40 mb-3">{t.contacts.officeTitle}</h3>
            <a 
        ...
        <motion.div 
          {...scrollRevealConfig}
          className="h-[400px] md:h-[600px] bg-[#eeeee9] rounded-3xl overflow-hidden relative border border-black/10 shadow-[0_30px_70px_rgba(0,0,0,0.06)]"
        >
          <Map
            theme="light"
            viewport={{
