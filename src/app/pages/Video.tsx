            ...
            >
              ...
              <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-4 z-10">
                <span className="font-mono text-[11px] text-[#808080] uppercase tracking-[0.04em] mb-1">
                  {item.detail?.year || "2026"} — {item.category || "Video"}
                </span>
          ...
          <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 sm:p-6 md:p-8">
            ...
            <div className="relative w-full max-w-[1500px] h-full max-h-[90vh] z-10">
              ...
              >
                ...
                <div className="w-full lg:w-[65%] flex flex-col bg-[#eeeee9] relative border-r border-[#808080]/20">
                  <div className="w-full pt-[35px] px-[35px] shrink-0 flex justify-between items-center">
                    <span className="font-mono text-[12px] text-[#808080] uppercase tracking-[0.04em]">
                      [01 / 01]
                    </span>
                  </div>

                  <div className="flex-1 relative flex items-center justify-center px-[35px] py-[25px] overflow-hidden">
                  ...
                  <div className="flex flex-col gap-6 w-full max-w-[480px]">
                    <div className="flex flex-col gap-2">
                      <span className="font-mono text-[13px] text-[#808080] uppercase tracking-[0.04em]">
                        {currentItem.detail?.year || "2026"} — {currentItem.category || "Video"}
                      </span>
...
function InstagramVideoPlayer({ src }: { src: string }) {
  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center cursor-pointer select-none" onClick={togglePlay}>
      <video
        ref={videoRef}
        src={src}
        className="max-w-full max-h-full object-contain rounded-[4px]"
      ...
      <button
        type="button"
        onClick={toggleMute}
        className="absolute bottom-6 right-6 px-5 py-2.5 bg-transparent hover:bg-[#0000FF] text-[#0000FF] hover:text-white transition duration-300 active:scale-95 z-20 border border-[#0000FF] flex items-center gap-2 font-mono text-[11px] uppercase tracking-wider font-bold rounded-[4px] shadow-md"
      >
        {isMuted ? (
          <>
