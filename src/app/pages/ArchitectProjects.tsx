...
export function ArchitectProjects() {
  ...
  const items = list.map((item: any) => {
    ...
    return {
      ...item,
      tags: detail.service || "Architecture",
    ...
    <div className="w-full flex flex-col pt-5 pb-[150px]">
      ...
      <section className="pb-4 mb-[40px] w-auto">
        ...
        <p className="text-[#808080] text-[16px] leading-[1.44] m-0 font-normal max-w-[650px]">
          {locale === "ru" 
            ? "Концептуальные архитектурные решения, виллы, общественные пространства и средовой дизайн" 
            : locale === "kg" 
              ? "Архитектуралык долбоорлор, виллалар, коомдук мейкиндиктер жана чөйрөнүн дизайны"
