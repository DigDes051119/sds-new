              ...
              <div className="w-full lg:w-[35%] flex flex-col p-[30px] md:p-[50px] lg:p-[60px] bg-[#f0f0f0] overflow-y-auto">
                ...
                <div className="flex flex-col gap-6 w-full max-w-[500px]">
                  ...
                  <p className="text-[18px] md:text-[22px] font-light leading-[1.4] tracking-[-0.02em] text-black m-0 italic">
                    "{currentItem?.quote && currentItem.quote.trim().length > 0 ? getLocText(locale, currentItem.quote, currentItem.quote) : colleagueIntroQuote}"
                  </p>

                  <p className="text-[15px] leading-[1.5] text-[#808080] m-0 font-normal">
                    {getLocText(locale, currentItem.fullDesc, currentItem.fullDesc)}
                  </p>
