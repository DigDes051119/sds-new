...
const translationsDictionary: Record<string, Record<Language, string>> = {
  "Исследование рынка и аудит конкурентов.": {
    en: "Market research and competitor audit.",
    ru: "Исследование рынка и аудит конкурентов.",
    kg: "Рынокту изилдөө жана атаандаштардын аудити.",
    zh: "市场调研与竞争对手审计。",
    ar: "أبحاث السوق وتدقيق المنافسين.",
    de: "Marktforschung und Wettbewerberanalyse.",
  },
  "Market research and competitor audit.": {
    en: "Market research and competitor audit.",
    ru: "Исследование рынка и аудит конкурентов.",
  ...
  "Разработка платформы бренда и концепций визуальной идентификации.": {
    en: "Platform development and visual identity concepts.",
    ru: "Разработка платформы бренда и концепций визуальной идентификации.",
    kg: "Бренд платформасын жана визуалдык идентификация концепцияларын иштеп чыгуу.",
    zh: "品牌平台开发与视觉识别概念设计。",
    ar: "تطوير منصة العلامة التجارية ومفاهيم الهوية البصرية.",
    de: "Plattformgestaltung und visuelle Identitätskonzepte.",
  },
  "Platform development and visual identity concepts.": {
    en: "Platform development and visual identity concepts.",
    ru: "Разработка платформы бренда и концепций визуальной идентификации.",
  ...
  "Создание брендбука и поддержка при внедрении.": {
    en: "Brand book creation and implementation support.",
    ru: "Создание брендбука и поддержка при внедрении.",
    kg: "Брендбукту түзүү жана аны киргизүүдө колдоо көрсөтүү.",
    zh: "品牌手册设计与落地执行支持。",
    ar: "إنشاء دليل العلامة التجارية ودعم التنفيذ.",
    de: "Brandbook-Erstellung und Implementierungsunterstützung.",
  },
  "Создание серии документов брендина состоящих минимально из 4 отдельных направлений.": {
    en: "Creating a series of branding documents consisting of at least 4 individual directions.",
    ru: "Создание серии документов брендина состоящих минимально из 4 отдельных направлений.",
    kg: "Кеминде 4 өзүнчө багыттан турган брендинг документтерин түзүү.",
    zh: "创建由至少4个独立方向组成的品牌系列设计文件。",
    ar: "إنشاء سلسلة من وثائق العلامة التجارية تتكون من 4 اتجاهات فردية على الأقل.",
    de: "Erstellung einer Reihe von Branding-Dokumenten, die aus mindestens 4 individuellen Richtungen bestehen.",
  },
  "Эскизирование, эргономический анализ и поиск формы.": {
    en: "Sketching, ergonomic analysis, and form exploration.",
    ru: "Эскизирование, эргономический анализ и поиск формы.",
    kg: "Эскиздөө, эргономикалык анализ жана форманы издөө.",
    zh: "草图绘制、人机工程学分析与造型探索。",
    ar: "الرسم والتحليل المريح واستكشاف الشكل.",
    de: "Skizzieren, ergonomische Analyse und Formfindung.",
  },
  "Sketching, ergonomic analysis, and form exploration.": {
    en: "Sketching, ergonomic analysis, and form exploration.",
    ru: "Эскизирование, эргономический анализ и поиск формы.",
  ...
  "Трехмерное моделирование (CAD) с учетом производственных ограничений.": {
    en: "3D modeling (CAD) with manufacturing constraints.",
    ru: "Трехмерное моделирование (CAD) с учетом производственных ограничений.",
    kg: "Өндүрүштүк чектөөлөрдү эске алуу менен үч өлчөмдүү моделдөө (CAD).",
    zh: "兼顾制造约束的三维数模设计（CAD）。",
    ar: "النمذجة ثلاثية الأبعاد (CAD) مع قيود التصنيع.",
    de: "3D-Modellierung (CAD) unter Berücksichtigung von Fertigungsbeschränkungen.",
  },
  "3D modeling with manufacturing constraints.": {
    en: "3D modeling (CAD) with manufacturing constraints.",
    ru: "Трехмерное моделирование (CAD) с учетом производственных ограничений.",
  ...
  "Создание прототипов и доработка деталей.": {
    en: "Prototype development and detail refinement.",
    ru: "Создание прототипов и доработка деталей.",
    kg: "Прототиптерди түзүү жана деталдарды тактоо.",
    zh: "原型制作与细节优化打磨。",
    ar: "تطوير النماذج الأولية وصقل التفاصيل.",
    de: "Prototypenerstellung und Detailentwicklung.",
  },
  "Prototype development and detail refinement.": {
    en: "Prototype development and detail refinement.",
    ru: "Создание прототипов и доработка деталей.",
  ...
  "Разработка маркетинговой стратегии и определение каналов коммуникации.": {
    en: "Strategy development and channel selection.",
    ru: "Разработка маркетинговой стратегии и определение каналов коммуникации.",
    kg: "Маркетингдик стратегияны иштеп чыгуу жана байланыш каналдарын аныктоо.",
    zh: "营销策划制定与沟通渠道筛选。",
    ar: "تطوير الاستراتيجية واختيار قنوات الاتصال.",
    de: "Strategieentwicklung und Kanalauswahl.",
  },
  "Strategy development and channel selection.": {
    en: "Strategy development and channel selection.",
    ru: "Разработка маркетинговой стратегии и определение каналов коммуникации.",
  ...
  "Создание рекламных креативов и запуск кампаний.": {
    en: "Creative production and campaign launch.",
    ru: "Создание рекламных креативов и запуск кампаний.",
    kg: "Жарнамалык креативдерди түзүү жана өнөктүктөрдү баштоо.",
    zh: "广告创意素材设计与投放执行推广。",
    ar: "الإنتاج الإبداعي وإطلاق الحملات الإعلانية.",
    de: "Kreativerstellung und Kampagnenstart.",
  },
  "Creative production and campaign launch.": {
    en: "Creative production and campaign launch.",
    ru: "Создание рекламных креативов и запуск кампаний.",
  ...
  "Аналитика эффективности и оптимизация показателей (ROI, CPA).": {
    en: "Performance analysis and optimization (ROI, CPA).",
    ru: "Аналитика эффективности и оптимизация показателей (ROI, CPA).",
    kg: "Натыйжалуулук аналитикасы жана көрсөткүчтөрдү оптималдаштыруу (ROI, CPA).",
    zh: "效果分析跟踪与投产比指标优化（ROI, CPA）。",
    ar: "تحليل الأداء وتحسين المؤشرات (ROI, CPA).",
    de: "Leistungsanalyse und Optimierung (ROI, CPA).",
  },
  "Performance analysis and optimization.": {
    en: "Performance analysis and optimization (ROI, CPA).",
    ru: "Аналитика эффективности и оптимизация показателей (ROI, CPA).",
  ...
  "Погружение в сеттинг, сбор референсов и генерация идей.": {
    en: "Immersion in setting, reference collection, and ideation.",
    ru: "Погружение в сеттинг, сбор референсов и генерация идей.",
    kg: "Сеттингге кирүү, референстерди чогултуу жана идеяларды жаратуу.",
    zh: "设定背景融入、参考素材搜集与创意构思。",
    ar: "الانغماس في الإعداد وجمع المراجع وتوليد الأفكار.",
    de: "Eintauchen in das Setting, Referenzsammlung und Ideenfindung.",
  },
  "Immersion in setting, reference collection, and ideation.": {
    en: "Immersion in setting, reference collection, and ideation.",
    ru: "Погружение в сеттинг, сбор референсов и генерация идей.",
  ...
  "Создание выразительных концепт-артов и быстрых 3D-болванок.": {
    en: "Creating expressive concept art and rapid 3D blockouts.",
    ru: "Создание выразительных концепт-артов и быстрых 3D-болванок.",
    kg: "Ачык концепт-арттарды жана тез 3D макеттерди түзүү.",
    zh: "概念艺术表达绘制与快速三维白模搭建。",
    ar: "إنشاء رسومات مفاهيمية معبرة ونماذج ثلاثية الأبعاد سريعة.",
    de: "Erstellung ausdrucksstarker Konzeptgrafiken und schneller 3D-Blockouts.",
  },
  "Creating expressive concept art and rapid 3D blockouts.": {
    en: "Creating expressive concept art and rapid 3D blockouts.",
    ru: "Создание выразительных концепт-артов и быстрых 3D-болванок.",
    kg: "Ачык концепт-арттарды жана тез 3D макеттерди түзүү.",
    zh: "概念艺术表达绘制与快速三维白模搭建。",
  ...
  "Детализация, финальный рендер и подготовка презентации концепта.": {
    en: "Detailing, final rendering, and concept presentation prep.",
    ru: "Детализация, финальный рендер и подготовка презентации концепта.",
    kg: "Деталдаштыруу, акыркы рендер жана концепциянын презентациясын даярдоо.",
    zh: "模型精细化雕刻、最终渲染图输出与演示汇报准备。",
    ar: "التفصيل والرسم النهائي وإعداد عرض المفهوم.",
    de: "Detailentwicklung, finales Rendering und Konzeptpräsentation.",
  },
  "Создание геймдизайн-документа и концепт-арта.": {
    en: "Game design document & concept art creation.",
    ru: "Создание геймдизайн-документа и концепт-арта.",
    kg: "Геймдизайн документин жана концепт-артты түзүү.",
    zh: "策划文档（GDD）编写与核心艺术概念绘制设计。",
    ar: "إنشاء وثيقة تصميم اللعبة والرسومات المفاهيمية.",
    de: "GDD-Erstellung und Konzeptgrafik.",
  },
  "Game design document & concept art creation.": {
    en: "Game design document & concept art creation.",
    ru: "Создание геймдизайн-документа и концепт-арта.",
  ...
  "3D-моделирование, текстурирование и дизайн уровней.": {
    en: "3D modeling, texturing & environment design.",
    ru: "3D-моделирование, текстурирование и дизайн уровней.",
    kg: "3D-моделдөө, текстуралоо жана деңгээлдерди долбоорлоо.",
    zh: "三维模型雕刻、材质贴图绘制与关卡美术布局。",
    ar: "النمذجة ثلاثية الأبعاد والإكساء وتصميم المستويات.",
    de: "3D-Modellierung, Texturierung und Leveldesign.",
  },
  "3D modeling, texturing & environment design.": {
    en: "3D modeling, texturing & environment design.",
    ru: "3D-моделирование, текстурирование и дизайн уровней.",
  ...
  "Настройка в игровом движке, программирование механик и оптимизация.": {
    en: "Engine setup, mechanics programming & optimization.",
    ru: "Настройка в игровом движке, программирование механик и оптимизация.",
    kg: "Оюн кыймылдаткычында жөндөө, механиканы программалоо жана оптималдаштыруу.",
    zh: "游戏引擎资产集成、核心玩法代码编写与运行性能调优。",
    ar: "الإعداد في محرك اللعبة وبرمجة الميكانيكا والتحسين.",
    de: "Engine-Integration, Gameplay-Programmierung und Optimierung.",
  },
  "Engine setup, mechanics programming & optimization.": {
    en: "Engine setup, mechanics programming & optimization.",
    ru: "Настройка в игровом движке, программирование механик и оптимизация.",
